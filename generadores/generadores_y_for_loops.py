...
print("\n")
for num in range(
        10):  # for que recorre los numeros que hay en un generador range de 10 numeros (range(10) genera 10 numeros del 0 al 9).
    print(
        "hello")  # acá va a imprimir 10 veces hello porque toma como numero de veces a recorrer lo que indica range(10).
    # print(num)
