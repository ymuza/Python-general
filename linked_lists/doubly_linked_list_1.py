class Node:
    """ class Node represents each node in the doubly linked list. It has three attributes: data to store the value of
     the node, prev as a reference to the previous node, and next as a reference to the next node."""
