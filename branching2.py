...
if op == 1 or op == 2 or op == 3 or op == 4:
    ...
    print("\n")
    print(f"{num1} is an even number") if num1 % 2 == 0 else print(
        f"{num1} is an odd number")  # se puede hacer todo en una linea de esta forma si la condicion no es muy compleja.
else:
...
resultado = my_dict[op](num1, num2)
